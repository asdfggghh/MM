...
const TRANSLATIONS = {
  en: {
    ...
    live:                "Live",
    call:                "📞 Call",
    speak_profile:       "🔊 Read Aloud",
    stop_speech:         "🛑 Stop Voice",
    speech_intro:        "Emergency medical profile for ",
    speech_blood:        "Blood group is ",
    speech_allergic:     "Patient is allergic to ",
    speech_conditions:   "Known medical conditions: ",
    speech_donor:        "Patient is a registered organ donor",
  },
  hi: {
    ...
    live:                "लाइव",
    call:                "📞 कॉल करें",
    speak_profile:       "🔊 बोलकर सुनें",
    stop_speech:         "🛑 आवाज़ बंद करें",
    speech_intro:        "आपातकालीन चिकित्सा प्रोफ़ाइल: ",
    speech_blood:        "रक्त समूह है ",
    speech_allergic:     "मरीज़ को एलर्जी है: ",
    speech_conditions:   "चिकित्सीय स्थितियाँ: ",
    speech_donor:        "मरीज़ एक पंजीकृत अंगदाता है",
  },
  bn: {
